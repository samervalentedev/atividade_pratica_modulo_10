...
const CriarTarefa = ({ handleClose, tarefas, setTarefas }) => {
  ...
  const handleSalvar = () => {
    ...
    //validação manual mas pode ser feita com uma biblioteca auxiliar como zod, joi, yup, etc.
    if (!tituloTarefa) {
      validateErrors["tituloTarefa"] = "Campo obrigatório";
    }

    if (!descricaoTarefa) {
      validateErrors["descricaoTarefa"] = "Campo obrigatório";
    }

    if (!inicioTarefa) {
      validateErrors["inicioTarefa"] = "Campo obrigatório";
    }

    if (!fimTarefa) {
      validateErrors["fimTarefa"] = "Campo obrigatório";
    }
        ...
        >
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              {errors["tituloTarefa"] && (
                <FormHelperText error={true} id="tarefa_titulo_helper_text">
                  {errors["tituloTarefa"]}
                </FormHelperText>
              )}
            </FormControl>
          ...
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              />
              <FormHelperText id="tarefa_descricao_helper_text"></FormHelperText>
              {!errors["descricaoTarefa"] && (
                <FormHelperText id="tarefa_titulo_helper_text">
                  Descrição da Tarefa.
                </FormHelperText>
              )}
